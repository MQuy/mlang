(function (global, factory) {
  ...
  class Parser {
      ...
      classStatement() {
          ...
          return new ClassStatement(name, varStatements, methodStatements, superclass);
      }
      functionStatement() {
          ...
          return new FunctionStatement(name, parameters, this.statement(), kind.lexeme);
      }
      returnStatement() {
          let expression;
          if (!this.match(exports.TokenType.SEMICOLON)) {
      ...
      exponentiationExpression() {
          let unary$$1 = this.unaryExpression();
          while (this.match(exports.TokenType.STAR_STAR)) {
              unary$$1 = new BinaryExpression(unary$$1, this.previous(), this.unaryExpression());
          }
          return unary$$1;
      }
      unaryExpression() {
      ...
      primaryExpression() {
          if (this.match(exports.TokenType.BOOLEAN, exports.TokenType.NUMBER, exports.TokenType.STRING, exports.TokenType.NULL)) {
              return new LiteralExpression(this.previous(), capitalize(this.previous().type));
          }
              ...
              return new LambdaExpression(paramenters, this.statement(), returnKind.lexeme);
          }
  ...
  class TypeChecking {
      ...
      visitClassStatement(statement) {
          ...
          if (statement.methods) {
              statement.methods.forEach(method => {
                  const kethod = new Functionable(method.name.lexeme, this.scope.lookup(method.returnType));
      ...
      visitFunctionStatement(statement) {
          const kunction = new Functionable(statement.name.lexeme, this.scope.lookup(statement.returnType));
      ...
      visitLambdaExpression(expression) {
          const kunction = new Functionable(undefined, this.scope.lookup(expression.returnType));
          expression.parameters.forEach(parameter => kunction.parameters.push(this.scope.lookup(parameter.type)));
          return kunction;
      }
